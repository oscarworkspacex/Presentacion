...
export const SLIDE_TITLE =
    'text-3xl lg:text-4xl font-bold leading-tight line-clamp-2'

export const SLIDE_BODY =
    'text-sm lg:text-base leading-relaxed line-clamp-6'

export const SLIDE_SUBTITLE =
    'text-base lg:text-lg font-semibold line-clamp-2'

export const SLIDE_IMAGE_SIDE =
    'w-full max-h-[280px] object-cover rounded-2xl shadow-lg'
